...
import pl.waldi.RecruitmentProject.appuser.AppUserRole;
import pl.waldi.RecruitmentProject.appuser.AppUserService;
import pl.waldi.RecruitmentProject.email.EmailSender;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request) {
        ...
        if(!isValidEmail) {
            throw new IllegalAccessException("waaaait... this email is not valid");
        }
    ...
    public String confirmToken(String token) {
        ...
        if (confirmationToken.getConfirmedAt() !=null) {
            throw new IllegalStateException("heey! seems that email is already confirmed");
        }
